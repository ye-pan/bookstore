...
public class QueryService {
    ...
    public QueryService(OrderListDenormalizer orderListDenormalizer, OrdersPerDayAggregator ordersPerDayAggregator, ProductCatalogClient productCatalogClient) {

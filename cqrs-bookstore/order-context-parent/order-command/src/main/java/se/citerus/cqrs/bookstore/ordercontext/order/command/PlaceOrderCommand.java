...
public class PlaceOrderCommand extends Command {
    ...
    public PlaceOrderCommand(OrderId orderId, CustomerInformation customerInformation, List<OrderLine> orderLines, BigDecimal totalAmount) {
        ...
        Preconditions.checkArgument(totalAmount.compareTo(BigDecimal.ZERO) > 0, "Total amount must be > 0");
